...
public class App1 
{
    public static void main( String[] args )
    {
       ...
       //2. Update Instructor_details
		/*
		 * System.out.println("Enter InstructorDetails ID = "); int id = s.nextInt();
		 * InstructorDetails instructorDetails = session.get(InstructorDetails.class,
		 * id); instructorDetails.setHobby("Baseball");
